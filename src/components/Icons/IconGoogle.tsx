...
import { StyledIconGoolge } from "../../styles/styles";

export default class IconGoogle extends Component {
  render(): ReactNode {
    return (
      <StyledIconGoolge>
        <svg width="125" height="18" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <filter id="a">
              <feColorMatrix
                in="SourceGraphic"
          ...
          >
            <g fillRule="nonzero">
              <g transform="translate(255 6)">
                <path fill="#FAB908" d="M7.72 11.91h2.205V5.558H7.719v3.705z" />
                <ellipse
                  fill="#0066D9"
                  cx="1.103"
                  cy="8.138"
                ...
                <ellipse
                  ...
                  ry="1.092"
                />
                <path fill="#4285F4" d="M17.644 9.33H15.44V8.139h2.205z" />
                <ellipse
                  fill="#EA4335"
                  cx="4.912"
                  cy="11.711"
                ...
                <ellipse
                  ...
                  ry="1.092"
                />
                <path fill="#34A853" d="M13.834 5.757H11.63V4.566h2.205z" />
                <ellipse
                  fill="#FAB908"
                  cx="8.822"
                  cy="2.283"
                ...
                <ellipse
                  ...
                  ry="1.092"
                />
                <path fill="#FAB908" d="M9.925 2.282H7.72v-1.19h2.205z" />
                <ellipse
                  fill="#FAB908"
                  cx="8.822"
                  cy="16.376"
                ...
                <ellipse
                  ...
                  ry="1.092"
                />
                <path fill="#FAB908" d="M9.925 16.376H7.72v-1.19h2.205z" />
                <ellipse
                  fill="#34A853"
                  cx="12.732"
                  cy="12.902"
                ...
                <ellipse
                  ...
                  ry="1.092"
                />
                <path fill="#34A853" d="M13.834 12.902H11.63v-3.87h2.205z" />
                <ellipse
                  fill="#FAB908"
                  cx="8.822"
                  cy="5.558"
